...
evaluation_path = './pkl/invite_info_evaluate_b.pkl'
...
since = time.time()
test_df = merge_test(invite_info, invite_info_evaluate, feature_name, is_fill_nan)
time_elapsed = time.time() - since
time_log(time_elapsed)

test_df.to_hdf('./my_feat/convert_test_b.h5', key='data')
